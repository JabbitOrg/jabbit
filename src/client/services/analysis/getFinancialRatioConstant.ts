import { FINANCIAL_RATIO_20S, FINANCIAL_RATIO_30S, FINANCIAL_RATIO_AVG } from "../../constants/MYPAGE";
import { FinancialRatioConfig } from "@/src/client/types/financial";

export const getFinancialRatioByBirthYear = (birthYear: number): FinancialRatioConfig => {
